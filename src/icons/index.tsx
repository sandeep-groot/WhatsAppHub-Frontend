...
export function SendMessageIcon(props: IconProps) {
  return (
    <svg
      className="w-5 h-5"
      fill="none"
...
export function ChevronDownWideIcon(props: IconProps) {
  return (
    <svg
      className="h-4 w-4"
      fill="none"
...
export function CopySimpleIcon(props: IconProps) {
  return (
    <svg
      className="w-4 h-4"
      fill="none"
...
export function CopyDuplicateIcon(props: IconProps) {
  return (
    <svg
...
export function BusinessAccountIcon(props: IconProps) {
  return (
    <svg
      className="h-5 w-5"
      fill="none"
...
export function MessageReadIcon(props: IconProps) {
  return (
    <svg
      className="h-3 w-3"
      fill="none"
...
export function MessageDeliveredIcon(props: IconProps) {
  return (
    <svg
      className="h-3 w-3"
      fill="none"
...
export function MessageSentIcon(props: IconProps) {
  return (
    <svg
      className="h-3 w-3"
      fill="none"
...
export function WhatsAppBubbleIcon(props: IconProps) {
  return (
    <svg
      className="w-8 h-8"
      fill="none"
