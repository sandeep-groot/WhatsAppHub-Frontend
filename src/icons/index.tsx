...
export function UsersIcon({ className, ...props }: IconProps) {
  return <ClientsIcon className={className} {...props} />;
}
...
export function RadioIcon({ className, ...props }: IconProps) {
  return <ConnectionsIcon className={className} {...props} />;
}
...
export function LinkIcon({ className, ...props }: IconProps) {
  return <WebhooksIcon className={className} {...props} />;
}
...
export function BriefcaseBusinessIcon({ className, ...props }: IconProps) {
  return (
    <svg
      className={mergeIconClass("w-5 h-5", className)}
      fill="none"
...
export function CheckCheckIcon({ className, ...props }: IconProps) {
  return (
    <svg
      className={mergeIconClass("w-4 h-4", className)}
      fill="none"
...
export function CopyIcon({ className, ...props }: IconProps) {
  return <CopyDuplicateIcon className={className} {...props} />;
}
...
export function FolderOpenIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <polygon points="12 11 12 17 17 14 12 11" />
    </svg>
  );
}
...
export function RefreshIcon({ className, ...props }: IconProps) {
  return <RotateIcon className={className} {...props} />;
}

/* Direct short alias re-exports */
export const BriefcaseBusiness = BriefcaseBusinessIcon;
export const Check = CheckIcon;
export const CheckCheck = CheckCheckIcon;
export const ChevronDown = ChevronDownIcon;
export const Copy = CopyDuplicateIcon;
